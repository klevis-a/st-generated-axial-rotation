...
#%%
    ...
    for i in range(3):
        style_axes(axs[i], 'Humerothoracic Elevation (Deg)' if i == 2 else None, 'Elevation (deg)')
        axs[i].set_ylim(0, 12)
    ...
    leg_left = fig.legend(leg_mean[:2], ['Euler SHR', 'Contrib SHR'], loc='upper left', bbox_to_anchor=(0, 1),
